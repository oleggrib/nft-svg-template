...
// ------------------------------------------------------------------//
// TODO Trigger/integrate this function and logic using params below:
...
(async () => {
  ...
  // ------------------------------------------------------------------//
  // TODO - We should create a way to evaluate the HTML
  ...
  // ------------------------------------------------------------------//
  // TODO - We should deprecate this logic as we dont
  // want to provide a screen shot only. This should be a fall back
  // if we cannot return an SVG.
